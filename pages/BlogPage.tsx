  ...
  return (
    <Shell title="News &amp; Updates">
      <section className="blog_area section-padding">
        <ContentWithRail>
          <div className="section-title"><h2>EduReach News &amp; Campus Gist</h2><p>News, updates, quick notices, campus conversations, admissions, examinations, funding and student opportunities.</p></div>
