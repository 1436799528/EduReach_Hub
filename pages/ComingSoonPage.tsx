import { ArrowRight, BellRing, LayoutGrid, MessageSquare, Newspaper } from 'lucide-react';
        ...
        <div className="hub-container hub-narrow" style={{ maxWidth: '640px' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', gap: '10px', justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <a
                href={`https://wa.me/${EDUREACH_WHATSAPP}?text=${encodeURIComponent(`Hello EduReach, I need help with ${copy.eyebrow.toLowerCase()}.`)}`}
                target="_blank"
