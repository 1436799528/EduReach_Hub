...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  if (checking) {
    return <div className="admin-loading-screen">Checking administrative access…</div>;
  }
    ...
    <div className="admin-shell">
      <aside className="admin-sidebar">
        <div>
          <div className="admin-brand">
            ...
            <div><strong>EduReach Admin</strong><span>Live Production</span></div>
          </div>
      ...
      <div className="admin-workspace">
        <header className="admin-topbar">
          ...
          <span className="admin-health-pill">System Health</span>
        </header>
