...
export default function CbtPracticePage() {
  ...
  return <HubLayout><div className="hub-cbt-engine">
    <div className="hub-cbt-topbar"><div><strong>EduReach CBT</strong><span>Use of English · JAMB 2026</span></div><div className="hub-cbt-timer"><TimerReset size={17}/> {mins}:{secs}</div><div className="hub-cbt-network">{offline && <><WifiOff size={15}/> Offline mode • progress saved locally</>}</div><button className="hub-primary-btn" onClick={() => window.location.href = '/cbt/results'}><Send size={16}/> Submit Exam</button></div>
