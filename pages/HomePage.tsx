...
export default function HomePage() {
  ...
  return (
    <Shell>
      ...
      <section id="services" className="cat_area section-padding"><div className="container"><div className="section-title text-center"><h2>What EduReach Provides</h2><p>Choose the practical student service you need.</p></div><div className="row">{services.map((service) => <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12" key={service.id}><div className="single_cat"><img src={service.image} alt={service.title} loading="lazy" /><div className="single_cat_text"><h4>{service.title}</h4><p>{service.description}</p><a href="/services">View Service <i className="fa fa-angle-right" /></a></div></div></div>)}</div></div></section>

      <section className="course_area section-padding"><div className="container"><div className="section-title text-center"><h2>Explore EduReach Services</h2><p>Practical services designed around everyday student needs.</p></div><div className="row">{services.map((service) => <div className="col-lg-4 col-sm-6 col-xs-12" key={service.id}><div className="single_course"><div className="single_c_img"><img src={service.image} className="img-fluid" alt={service.title} loading="lazy" /><span>{service.shortTitle}</span></div><div className="single_course_text"><span className={service.icon} style={{ fontSize: 28 }} /><h4>{service.title}</h4><p>{service.description}</p><a href="/services" className="btn_one">{service.cta}</a></div></div></div>)}</div></div></section>
