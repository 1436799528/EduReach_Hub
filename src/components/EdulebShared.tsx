          ...
          <div className="row">
            <div className="col-20 align-self-center">
              <div className="site-logo">
                <a href="#home" className="edureach-logo" aria-label="EduReach Hub home">
