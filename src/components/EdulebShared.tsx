    ...
    <>
      <div id="navigation" className="navbar-light bg-faded site-navigation">
        <div className="container-fluid"><div className="row">
          <div className="col-20 align-self-center"><div className="site-logo"><a href="/" className="edureach-logo" aria-label="EduReach Hub home"><span>EduReach</span> <strong>Hub</strong></a></div></div>
          <div className="col-60 d-flex"><nav id="main-menu"><ul><li><a href="/">Home</a></li><li><a href="/about">About</a></li><li><a href="/services">Services</a></li><li><a href="/blog">News</a></li><li><a href="/contact">Contact</a></li></ul></nav></div>
          ...
          <ul className="mobile_menu"><li><a href="/">Home</a></li><li><a href="/about">About</a></li><li><a href="/services">Services</a></li><li><a href="/blog">News</a></li><li><a href="/contact">Contact</a></li><li><button type="button" className="mobile-auth-button" onClick={() => setAuthMode('signin')}>Sign In</button></li><li><button type="button" className="mobile-auth-button mobile-auth-primary" onClick={() => setAuthMode('signup')}>Sign Up</button></li></ul>
        </div></div>
      </div>
