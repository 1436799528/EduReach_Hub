          ...
          <div className="row">
            <div className="col-20 align-self-center">
              <div className="site-logo">
                <a href="/" className="edureach-logo" aria-label="EduReach Hub home">
                  <span>EduReach</span> <strong>Hub</strong>
                </a>
              </div>
            </div>
            <div className="col-60 d-flex"><nav id="main-menu"><ul><li><a href="/">Home</a></li><li><a href="/about">About</a></li><li><a href="/services">Services</a></li><li><a href="/blog">Blog</a></li><li><a href="/contact">Contact</a></li></ul></nav></div>
...
export function ContentWithRail({ children, className = '' }: { children: ReactNode; className?: string }) {
  return <div className={`container content-rail-layout ${className}`.trim()}><div className="row align-items-start"><div className="col-xl-8 col-lg-8 content-main">{children}</div><div className="col-xl-4 col-lg-4 content-aside"><StudentRail /></div></div></div>;
}
