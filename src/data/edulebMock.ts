...
export const services: ServiceItem[] = [
  { id: 'nelfund-loan', title: 'NELFUND Loan Application', shortTitle: 'NELFUND', description: 'Loan application support and next-step guidance.', icon: 'ti-money', image: `${theme}/cat1.jpg`, cta: 'Apply Now' },
  { id: 'results', title: 'WAEC / NECO Result Checking', shortTitle: 'Results', description: 'Result checking support for WAEC and NECO.', icon: 'ti-check-box', image: `${theme}/cat2.jpg`, cta: 'Check Result' },
  { id: 'scratch-cards', title: 'WAEC / NECO Scratch Cards', shortTitle: 'Scratch Cards', description: 'Get the right result-checking card or code.', icon: 'ti-credit-card', image: `${theme}/cat3.jpg`, cta: 'Buy Card' },
  { id: 'jamb-slip', title: 'JAMB Exam Slip Printing', shortTitle: 'JAMB', description: 'Locate, check and print your JAMB slip.', icon: 'ti-printer', image: `${theme}/cat4.jpg`, cta: 'Print Slip' },
  { id: 'admission-letters', title: 'Admission Deferment & Supplementary Letters', shortTitle: 'Admissions', description: 'Prepare deferment and supplementary letters.', icon: 'ti-file', image: `${theme}/cat5.jpg`, cta: 'Start Request' },
];
