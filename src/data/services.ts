...
export const services: ServiceDefinition[] = [
  ...
  { key: 'school-finder', title: 'School Finder', category: 'Admission', route: '/schools', icon: '/icons/services/school-finder.svg', type: 'edureach', description: 'Find institutions and compare admission information.', requiresApplication: false },
