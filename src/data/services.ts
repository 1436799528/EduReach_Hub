...
export const services: ServiceDefinition[] = [
  { key: 'jamb', title: 'JAMB Services', category: 'Examinations', route: '/jamb', icon: '/icons/brands/jamb.svg', type: 'brand', description: 'JAMB information, guidance and related student services.', requiresApplication: false },
  { key: 'jamb-cbt', title: 'JAMB CBT', category: 'Examinations', route: '/cbt', icon: '/icons/brands/jamb.svg', type: 'brand', description: 'Computer-based practice and examination preparation.', requiresApplication: false },
  ...
  { key: 'waec', title: 'WAEC', category: 'Examinations', route: '/waec', icon: '/icons/brands/waec.svg', type: 'brand', description: 'WAEC information, preparation and result resources.', requiresApplication: false },
  { key: 'neco', title: 'NECO', category: 'Examinations', route: '/neco', icon: '/icons/brands/neco.svg', type: 'brand', description: 'NECO information, preparation and result resources.', requiresApplication: false },
  { key: 'nabteb', title: 'NABTEB', category: 'Examinations', route: '/nabteb', icon: '/icons/brands/nabteb.svg', type: 'brand', description: 'NABTEB examination information and resources.', requiresApplication: false },
  ...
  { key: 'nelfund', title: 'NELFUND', category: 'Financial Aid', route: '/nelfund', icon: '/icons/brands/nelfund.svg', type: 'brand', description: 'NELFUND eligibility, guidance and application information.', requiresApplication: false },
