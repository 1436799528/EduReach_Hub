...
export const services: ServiceDefinition[] = [
  ...
  { key: 'past-questions', title: 'Past Question Bank', category: 'Examinations', route: '/past-questions', icon: '/news/photos/jamb-cbt.jpg', type: 'edureach', description: 'Practice questions organised by examination, year and subject.', requiresApplication: false },
  ...
  { key: 'scholarships', title: 'Scholarships', category: 'Financial Aid', route: '/scholarships', icon: '/news/photos/graduates.jpg', type: 'edureach', description: 'Find scholarship opportunities and application guidance.', requiresApplication: false },
